...
interface CaseStudyDocumentData {
  ...
  /**
   * Image Logo field in *Case Study*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: case_study.image_logo
   * - **Tab**: Main
...
export interface ShowcaseSliceDefaultPrimary {
  ...
  /**
   * Sub Heading field in *Showcase → Primary*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: showcase.primary.sub_heading
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  ...
  /**
   * Button Label field in *Showcase → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: showcase.primary.button_label
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  button_label: prismic.KeyTextField
